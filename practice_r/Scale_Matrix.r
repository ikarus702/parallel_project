...
Ginv <- tcrossprod(multdiag(X=Eigenobject$vectors,d=1/(Eigenobject$values+V1)),Eigenobject$vectors)
coeffs <- tcrossprod(Ginv,t(y))
S1 <- crossprod(coeffs/diag(Ginv))
...
Ginv <- tcrossprod(multdiag(X=Eigenobject$vectors,d=1/(Eigenobject$values+V2)),Eigenobject$vectors)
coeffs <- tcrossprod(Ginv,t(y))
S2 <- crossprod(coeffs/diag(Ginv))
...
comm.print(d_Eigenobject$values, all.rank=FALSE)
## lambda search
